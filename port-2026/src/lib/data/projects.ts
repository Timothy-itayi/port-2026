...
export const projects: Project[] = [
	...
	},
	{
		slug: 'restock',
		title: 'Restock',
		subtitle: 'Inventory Management iOS App',
		author: 'Timothy Itayi',
	...
	},
	{
		...
		description: 'A deliberate foray into unfamiliar territory with Elm and Astro to demonstrate adaptability and cross-paradigm front-end competency for a potential role.',
		category: 'web-app',
		year: '2025',
	...
	},
	{
		slug: 'genius-sports',
		title: 'Genius Sports',
		subtitle: 'Sports Platform UI Clone',
		author: 'Timothy Itayi',
		image: '/projects/genuis-sports.png',
		description: 'A reverse-engineering exercise targeting Genius Sports\' micro-interactions including animated buttons and infinite scroll, built to demonstrate React proficiency for a potential role.',
		category: 'web-app',
		year: '2025',
	...
	},
	{
		slug: 'kogan',
		title: 'Kogan',
		subtitle: 'E-commerce Product Page Clone',
		author: 'Timothy Itayi',
	...
	},
	{
		slug: 'show-down',
		title: 'Show Down',
		subtitle: 'Mobile Card Battle Game',
		author: 'Timothy Itayi',
		...
		previewVideo: '/preview-videos/showdown-dev-demo.mov',
		portraitPreview: true
	},
	{
		slug: 'coffee-snob',
		title: 'CoffeeSnob',
		subtitle: 'Cafe Discovery iOS App',
		author: 'Timothy Itayi',
	...
	},
	{
		...
		previewVideo: '/preview-videos/F1-heritage-preview.mov'
	},
	{
		slug: 'waitless',
		title: 'Waitless',
	...
	},
	{
		slug: 'stacks',
		title: 'Stacks',
		subtitle: 'Physics Block-Stacking Game',
		author: 'Timothy Itayi',
		...
		previewVideo: '/preview-videos/Stacks.mov'
	},
	{
		slug: 'spincycle',
		title: 'SpinCycle',
		subtitle: 'Slot Machine Web Game',
		author: 'Timothy Itayi',
		image: '/slot.png',
		...
		previewVideo: '/preview-videos/SpinCycle.mov'
	},
	{
		slug: 'hashtable-visualiser',
		title: 'HashTable Visualiser',
		subtitle: 'Data Structure Teaching Tool',
		author: 'Timothy Itayi',
		...
		previewVideo: '/preview-videos/Hashtable.mov'
	},
	{
		slug: 'grandprix-history',
		title: 'Grand Prix History',
		subtitle: 'F1 Data Aggregation Platform',
		author: 'Timothy Itayi',
		...
		previewVideo: '/preview-videos/grand-prix-history.mov'
	},
	{
		slug: 'soundscape',
		title: 'Soundscape',
		...
		previewVideo: '/preview-videos/soundscape.mov'
	},
	{
		slug: 'blog-with-sanity',
		...
		content: `
			<p>A developer's journey through coding, game design, and web development. This blog explores projects, tutorials, and insights built with Next.js, C#, and more.</p>
			<h3>The Stack</h3>
			<p>Next.js handles the front-end rendering and routing, while Sanity provides the headless CMS backend for content management. This combination allows for a fast, statically generated blog with a flexible content editing experience through Sanity Studio.</p>
		`,
		previewVideo: '/preview-videos/Nextjs-Blog.mov'
	}
];
...
export const getProjectsByCategory = (cat: ProjectCategory): Project[] =>
	projects
		...
		.sort((a, b) => {
			if (a.previewVideo && !b.previewVideo) return -1;
			if (!a.previewVideo && b.previewVideo) return 1;
			return 0;
		});
